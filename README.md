...
```
git clone https://github.com/brianwpaxton/docker-sensu-server.git
...
```
docker run -d -p 10022:22 -p 3000:3000 -p 4567:4567 -p 5671:5671 -p 15672:15672 brianwpaxton/docker-sensu-server
```
